...
const PINNED_ITEMS: NavItem[] = [
  ...
  { href: "/lights", label: "Lights", icon: "bulb" },
...
function NavIcon({ icon, className }: { icon: string; className?: string }) {
  const icons: Record<string, React.ReactNode> = {
    ...
    bulb: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3a6 6 0 0 0-3.6 10.8c.5.4.8 1 .8 1.6V17a1 1 0 0 0 1 1h3.6a1 1 0 0 0 1-1v-1.6c0-.6.3-1.2.8-1.6A6 6 0 0 0 12 3Z" />
